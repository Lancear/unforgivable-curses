// WHAT THE F* IS THIS? one might ask
// I noticed that extending the Promise class to create a custom promise
// delays the custom promise by 2 microtask when using await.
// This effect is only there when using async/await syntax, .then chains work like normal.
//
// This probably has to do with the implementation of Promise.resolve, objects with a .then function
// (thenables) are handled differently than real promises.
// By extending the promise it is probably recognised as a thenable instead of a promise 
// by Promise.resolve.
